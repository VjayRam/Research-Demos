...
def test_multiple_zone_a_v_bitwidths_keep_k_v_aligned_per_token():
    # Regression test: kept tokens span more than one non-16-bit bit-width
    # (8 and 4 and 2 here), whose zone_a_v segments interleave across
    # original token order once concatenated. If the K rows fed into the
